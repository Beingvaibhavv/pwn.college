...
### Solve
**Flag:** `pwn.college{4g4K1wxNV7M7TZH-Th42Scw8Vxd.QX0EDO0wSMzAzNzEzW}`

just followed the description and got the flag
got the path from the terminal itself
read man challenge page and identified the the gwxchw 441 condition


```bash
cd /
man challenge 
/challenge/challenge --gwxchw 441
```
