...
### Solve
**Flag:** `pwn.college{k8j2jqs5HDT68E4gIJ8vcp0Ul4p.QXyMDO0wSMzAzNzEzW}`

just followed the instructions and used find command to get the flag location


```bash
cd /
find -name flag
cat usr/share/racket/pkgs/typed-racket-lib/typed/racket/base/compiled/flag
```

### New Learnings
used find command to find the hidden flag
